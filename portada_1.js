...
function toggleCollapse(element) {
    ...
    const symbol = element.querySelector('.collapsible-symbol');
...
function toggleSubmenu(navItem) {
    const submenuu = navItem.querySelector('.submenuu');
    navItem.classList.toggle('expanded');

    if (submenuu.style.display === 'block') {
        submenuu.style.display = 'none';
    } else {
        submenuu.style.display = 'block';
    }
}
